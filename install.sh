...
AUTOCOMPLETE_INSTALL_URL="https://raw.githubusercontent.com/ImNotMrReaper/antigravity-tui-autocorrect-spellcheck-suggest/main/install.sh"
...
while true; do
    ...
    echo -e "  ${CYAN}[5]${RESET} ⚡  Antigravity TUI Autocorrect, Spell Checker & Suggestive Text"
